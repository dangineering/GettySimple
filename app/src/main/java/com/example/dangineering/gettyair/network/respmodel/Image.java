...
public class Image {
     ...
     */
    public Image(String id, String assetFamily, Object caption, String collectionCode, Integer collectionId, String collectionName, List<DisplaySize> displaySizes, String licenseModel, MaxDimensions maxDimensions, String title) {
        this.id = id;
